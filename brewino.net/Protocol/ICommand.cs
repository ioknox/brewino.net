...
namespace brewino.net
{
    ...
    [MessagePack.Union((int)CommandEnum.SendStatus, typeof(SendReportCommand))]
    [MessagePack.Union((int)CommandEnum.SetTankLevel, typeof(SetTankLevelCommand))]
    [MessagePack.Union((int)CommandEnum.SetPin, typeof(SetPinCommand))]
    [MessagePack.Union((int)CommandEnum.Status, typeof(Status))]
