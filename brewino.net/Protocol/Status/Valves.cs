...
namespace brewino.net
{
    ...
    {
        [Key("bf")]
        public Pin ValveBoilToMash { get; set; } = new Pin();

        [Key("bfc")]
        public Pin ValveBoilToFilterViaCooler { get; set; }= new Pin();

        [Key("mf")]
        public Pin ValveMashToFilter { get; set; } = new Pin();

        [Key("mfc")]
        public Pin ValveMashToFilterViaCooler { get; set; } = new Pin();

        [Key("cwi")]
        public Pin ValveCityWaterIn { get; set; } = new Pin();

        [Key("cs")]
        public Pin ValveCitySewer { get; set; } = new Pin();

        [Key("cwb")]
        public Pin ValveCityWaterToBoil { get; set; } = new Pin();

        [Key("fb")]
        public Pin ValveFilterToBoil { get; set; } = new Pin();

        [Key("fm")]
        public Pin ValveFilterToMash { get; set; } = new Pin();
    }
