...
namespace brewino.net
{
    ...
    public class Status : ICommand
    {
        ...
        [Key("tk0")]
        public Tank TankMash { get; set; } = new Tank();

        [Key("tk1")]
        public Tank TankBoil { get; set; } = new Tank();

        [Key("m0")]
        public Motor MotorMixer { get; set; } = new Motor();

        [Key("m1")]
        public Motor MotorPump { get; set; } = new Motor();
