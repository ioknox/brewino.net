...
namespace brewino.net
{
    ...
    [MessagePackObject]
    public class SetTankLevelCommand : ICommand
    {
        [Key(0)]
        public TankEnum Tank { get; set; }

        [Key(1)]
        public short Level { get; set; }

        public SetTankLevelCommand()
            : this(TankEnum.Unknown, 0)
        {
            // Required by message pack
        }

        public SetTankLevelCommand(TankEnum tank, short level)
        {
            Tank = tank;
            Level = level;
        }
